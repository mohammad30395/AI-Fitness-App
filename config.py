...
MACRO_OPENROUTER_COMPONENT_ID = os.getenv(
    "MACRO_OPENROUTER_COMPONENT_ID",
    "ext:openrouter:OpenRouterComponent@official-snoVc",
)
ASK_ROUTER_OPENROUTER_COMPONENT_ID = os.getenv(
    "ASK_ROUTER_OPENROUTER_COMPONENT_ID",
    "ext:openrouter:OpenRouterComponent@official-lyVR9",
)
ASK_ADVICE_OPENROUTER_COMPONENT_ID = os.getenv(
    "ASK_ADVICE_OPENROUTER_COMPONENT_ID",
    "ext:openrouter:OpenRouterComponent@official-N7r20",
)
ASK_MATH_AGENT_COMPONENT_ID = os.getenv("ASK_MATH_AGENT_COMPONENT_ID", "Agent-8TtHH")
MACRO_OPENROUTER_MAX_TOKENS = os.getenv("MACRO_OPENROUTER_MAX_TOKENS", "512")
ASK_ROUTER_OPENROUTER_MAX_TOKENS = os.getenv("ASK_ROUTER_OPENROUTER_MAX_TOKENS", "128")
ASK_ADVICE_OPENROUTER_MAX_TOKENS = os.getenv("ASK_ADVICE_OPENROUTER_MAX_TOKENS", "1024")
ASK_MATH_AGENT_MAX_TOKENS = os.getenv("ASK_MATH_AGENT_MAX_TOKENS", "512")
...
FUTURE_OPTIONAL_VARIABLES = (
    # The Streamlit app still calls Langflow; these values tune Langflow's
    # OpenRouter components through native request tweaks.
    "OPENROUTER_API_KEY",
    "MACRO_OPENROUTER_COMPONENT_ID",
    "ASK_ROUTER_OPENROUTER_COMPONENT_ID",
    "ASK_ADVICE_OPENROUTER_COMPONENT_ID",
